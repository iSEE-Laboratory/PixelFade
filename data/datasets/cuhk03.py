...
class CUHK03(BaseImageDataset):
    ...
    def __init__(self, root='./toDataset', split_id=0, cuhk03_labeled=False,
        ...
        #更改数据地址
        list_img_path = ['train', 'query', 'gallery']
        for list in list_img_path:
            paths = splits[0][list]
            for i, path in enumerate(paths):
                path = path[0]
                # path = path.replace('/home/ancong/PycharmProjects/cloned_projects/UDAStrongBaseline/data/cuhk03/',
                                                #   '/mnt/Datasets/reid_dataset/cuhk03/')
                # print(path)
                splits[0][list][i][0] = path.replace('/home/ancong/PycharmProjects/cloned_projects/UDAStrongBaseline/data/cuhk03/',
                                                  '/mnt/Datasets/reid_dataset/cuhk03/')
                # print(splits[0][list][i][0])
                # assert 0
